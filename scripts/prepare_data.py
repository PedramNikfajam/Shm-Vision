...
def get_class_name(structure: str, condition: str) -> str:
    ...
    """
    # Normalize structure name (pavements -> pavement)
    structure = structure.lower().rstrip('s') if structure.lower() == 'pavements' else structure.lower()
...
def print_summary(
    ...
    print(f"You can now train with: python src/train.py --data config/data.yaml")
    print("=" * 70)
